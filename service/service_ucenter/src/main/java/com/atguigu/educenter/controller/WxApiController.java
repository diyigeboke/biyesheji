...
public class WxApiController {
    ...
    public String callback(String code, String state) {
        try {
            ...
            //2 拿着code请求微信固定地址，得到两个值access_token 和 openid
            ...
            if (member == null){//member是空，表没有相同微信数据，进行添加
                //3 拿着得到access_token和openid,再去请求微信提供固定的地址，获取扫描人信息
                //访问微信的资源服务器，获取用户信息
                ...
                String mobile = (String)userInfoMap.get("mobile");//手机
                String password = (String)userInfoMap.get("password");//密码
